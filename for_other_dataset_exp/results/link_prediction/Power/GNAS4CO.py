...
if __name__ == '__main__':
    ...
    desc = "{layer1:{ agg:sum, combine:concat, act:relu, layer_connect:skip_cat}; layer2:{ agg:max, combine:concat, act:prelu,layer_connect:stack}; layer_agg:max_pooling;}"
